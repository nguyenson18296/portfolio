...
export const SideInfo: React.FC = () => {
  return (
    <div className="w-full mx-auto minfo__sidebar__wrapper xl:fixed xl:top-1/2 xl:left-4 2xl:left-14 xl:-translate-y-1/2 sm:max-w-sidebar xl:max-w-xs 2xl:max-w-xs xl z-999">
        ...
        <div className="pt-6 mx-4 border-t lg:mx-6 user-meta-info md:mx-7 my-7 border-platinum dark:border-metalBlack">
          ...
          <div className="py-5 rounded-2xl bg-flashWhite dark:bg-metalBlack">
            ...
            <div className="grid gap-1 grid-cols-2">
              {MY_SKILLS.map(item => (
                <span className="flex items-center my-2" key={item.id}>
